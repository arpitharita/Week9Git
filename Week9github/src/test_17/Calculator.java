...
//17. Carpet Cost SimpleCalculator
...
//the field.
//In case
// the cost parameter islessthan 0 it needsto set the cost field value to 0.
//
//Write the following methods(instance methods):
//● Method named getCost without any parameters, it needsto return the value of cost field
//3. Write a class with the name SimpleCalculator. The class needstwo fields(instance variables) with name
...
//SimpleCalculator calculator = new SimpleCalculator(floor, carpet);
//System.out.println("total= " + calculator.getTotalCost());
//carpet = new Carpet(1.5);
//floor = new Floor(5.4, 4.5);
//calculator = new SimpleCalculator(floor, carpet);
//System.out.println("total= " + calculator.getTotalCost());
//→ OUTPUT
//total= 38.5
//total= 36.45
